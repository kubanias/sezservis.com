...
function page_on_css(): void {
	compressor::include_css(__info('view_url') . '/pages/responsibility/style.less');
...
function about_company(): void{
	echo '<div class="about_company">';
		echo '<div class="left block">';
			echo '<h1>Социальная <br> ответственность</h1>';
		...
		echo '<div class="right block">';
			echo '<div class="history">';
				echo '<div class="history_text">Соц. ответственность</div>';
			echo '</div>';
				echo '<div class="image_block">';
					echo '<img src="view\pages\images\Family-picture-for-web-site.webp" alt="" class="">';
				echo '</div>';
		echo '</div>';
